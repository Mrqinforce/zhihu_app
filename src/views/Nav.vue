			...
			<div class="zh-nav-bar" v-if="fixed">
				<ul class="zh-fx-left gutter">
					...
					<div class="fruid-col-5 d-flex align-items-center pl-4 search-bar">
											<div class="search-box mr-2" @click="popUp = !popUp" contenteditable="true">武汉加油</w></div>
											<transition name="fade">
												<div class="search-container border" v-if="popUp">
													...
													<a href="" class="border-bottom d-block">搜索历史 <button class="btn">清空</button></a>
						...
						<transition name="fade">
							<ul class="fill-white border shadow profile-box" v-if="show">
								<li class="d-flex align-items-center mb-1">
									<!-- <svg class="grey-icon mr-2" viewBox="0 0 24 24" width="16" height="16" style="padding-right: 2px;">
										<path
								...
								<li class="d-flex align-items-center mb-1">
									<!-- <svg class="grey-icon mr-1" viewBox="0 0 24 24" width="16" height="16">
										<path
			...
			<transition name="hide-bar">
				<div class="zh-nav-bar" v-if="!fixed">
					<ul class="zh-fx-left gutter">
						...
						<li class="nav-itemT"><router-link to="/home/recommoned">推荐</router-link></li>
						<li class="nav-itemT"><router-link to="/home/follow">关注</router-link></li>
						<li class="nav-itemT"><router-link to="/home/hot">热榜</router-link></li>
						
						<div class="d-flex justify-content-end align-items-center mt-2 to">
							<div class="search-box mr-2">搜索你感兴趣的内容...</div>
							<button class="blue-fill-btn">提问</button>
							</div>
						</ul>
				</div>
